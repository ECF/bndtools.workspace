...
public final class HealthCheckGrpc {
  ...
  public static final String SERVICE_NAME = "test.grpc.HealthCheck";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<test.grpc.HealthCheckRequest,
      test.grpc.HealthCheckResponse> getCheckMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "Check",
      requestType = test.grpc.HealthCheckRequest.class,
      responseType = test.grpc.HealthCheckResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<test.grpc.HealthCheckRequest,
      test.grpc.HealthCheckResponse> getCheckMethod() {
    io.grpc.MethodDescriptor<test.grpc.HealthCheckRequest, test.grpc.HealthCheckResponse> getCheckMethod;
      ...
      synchronized (HealthCheckGrpc.class) {
        if ((getCheckMethod = HealthCheckGrpc.getCheckMethod) == null) {
          HealthCheckGrpc.getCheckMethod = getCheckMethod =
              io.grpc.MethodDescriptor.<test.grpc.HealthCheckRequest, test.grpc.HealthCheckResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "Check"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  test.grpc.HealthCheckRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  test.grpc.HealthCheckResponse.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<test.grpc.HealthCheckRequest,
      test.grpc.HealthCheckResponse> getWatchServerMethod;
  ...
  public static io.grpc.MethodDescriptor<test.grpc.HealthCheckRequest,
      test.grpc.HealthCheckResponse> getWatchServerMethod() {
    io.grpc.MethodDescriptor<test.grpc.HealthCheckRequest, test.grpc.HealthCheckResponse> getWatchServerMethod;
  ...
  private static volatile io.grpc.MethodDescriptor<test.grpc.HealthCheckRequest,
      test.grpc.HealthCheckResponse> getWatchClientMethod;
  ...
  public static io.grpc.MethodDescriptor<test.grpc.HealthCheckRequest,
      test.grpc.HealthCheckResponse> getWatchClientMethod() {
    io.grpc.MethodDescriptor<test.grpc.HealthCheckRequest, test.grpc.HealthCheckResponse> getWatchClientMethod;
  ...
  private static volatile io.grpc.MethodDescriptor<test.grpc.HealthCheckRequest,
      test.grpc.HealthCheckResponse> getWatchBidiMethod;
  ...
  public static io.grpc.MethodDescriptor<test.grpc.HealthCheckRequest,
      test.grpc.HealthCheckResponse> getWatchBidiMethod() {
    io.grpc.MethodDescriptor<test.grpc.HealthCheckRequest, test.grpc.HealthCheckResponse> getWatchBidiMethod;
  ...
  public static abstract class HealthCheckImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void check(test.grpc.HealthCheckRequest request,
     ...
     * </pre>
     */
    public void watchServer(test.grpc.HealthCheckRequest request,
        io.grpc.stub.StreamObserver<test.grpc.HealthCheckResponse> responseObserver) {
     ...
     * </pre>
     */
    public io.grpc.stub.StreamObserver<test.grpc.HealthCheckRequest> watchClient(
        io.grpc.stub.StreamObserver<test.grpc.HealthCheckResponse> responseObserver) {
     ...
     * </pre>
     */
    public io.grpc.stub.StreamObserver<test.grpc.HealthCheckRequest> watchBidi(
        io.grpc.stub.StreamObserver<test.grpc.HealthCheckResponse> responseObserver) {
  ...
  public static final class HealthCheckBlockingStub extends io.grpc.stub.AbstractBlockingStub<HealthCheckBlockingStub> {
     ...
     * </pre>
     */
    public test.grpc.HealthCheckResponse check(test.grpc.HealthCheckRequest request) {
     ...
     * </pre>
     */
    public java.util.Iterator<test.grpc.HealthCheckResponse> watchServer(
        test.grpc.HealthCheckRequest request) {
  ...
  public static final class HealthCheckFutureStub extends io.grpc.stub.AbstractFutureStub<HealthCheckFutureStub> {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<test.grpc.HealthCheckResponse> check(
        test.grpc.HealthCheckRequest request) {
  ...
  private static final class MethodHandlers<Req, Resp> implements
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_CHECK:
          serviceImpl.check((test.grpc.HealthCheckRequest) request,
              (io.grpc.stub.StreamObserver<test.grpc.HealthCheckResponse>) responseObserver);
          break;
        case METHODID_WATCH_SERVER:
          serviceImpl.watchServer((test.grpc.HealthCheckRequest) request,
              (io.grpc.stub.StreamObserver<test.grpc.HealthCheckResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class HealthCheckBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return test.grpc.HealthProto.getDescriptor();
    }
