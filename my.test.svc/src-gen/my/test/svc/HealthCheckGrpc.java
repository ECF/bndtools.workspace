...
public final class HealthCheckGrpc {
  ...
  public static final String SERVICE_NAME = "my.test.svc.HealthCheck";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<my.test.svc.HealthCheckRequest,
      my.test.svc.HealthCheckResponse> getCheckMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "Check",
      requestType = my.test.svc.HealthCheckRequest.class,
      responseType = my.test.svc.HealthCheckResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<my.test.svc.HealthCheckRequest,
      my.test.svc.HealthCheckResponse> getCheckMethod() {
    io.grpc.MethodDescriptor<my.test.svc.HealthCheckRequest, my.test.svc.HealthCheckResponse> getCheckMethod;
      ...
      synchronized (HealthCheckGrpc.class) {
        if ((getCheckMethod = HealthCheckGrpc.getCheckMethod) == null) {
          HealthCheckGrpc.getCheckMethod = getCheckMethod =
              io.grpc.MethodDescriptor.<my.test.svc.HealthCheckRequest, my.test.svc.HealthCheckResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "Check"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  my.test.svc.HealthCheckRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  my.test.svc.HealthCheckResponse.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<my.test.svc.HealthCheckRequest,
      my.test.svc.HealthCheckResponse> getWatchServerMethod;
  ...
  public static io.grpc.MethodDescriptor<my.test.svc.HealthCheckRequest,
      my.test.svc.HealthCheckResponse> getWatchServerMethod() {
    io.grpc.MethodDescriptor<my.test.svc.HealthCheckRequest, my.test.svc.HealthCheckResponse> getWatchServerMethod;
  ...
  private static volatile io.grpc.MethodDescriptor<my.test.svc.HealthCheckRequest,
      my.test.svc.HealthCheckResponse> getWatchClientMethod;
  ...
  public static io.grpc.MethodDescriptor<my.test.svc.HealthCheckRequest,
      my.test.svc.HealthCheckResponse> getWatchClientMethod() {
    io.grpc.MethodDescriptor<my.test.svc.HealthCheckRequest, my.test.svc.HealthCheckResponse> getWatchClientMethod;
  ...
  private static volatile io.grpc.MethodDescriptor<my.test.svc.HealthCheckRequest,
      my.test.svc.HealthCheckResponse> getWatchBidiMethod;
  ...
  public static io.grpc.MethodDescriptor<my.test.svc.HealthCheckRequest,
      my.test.svc.HealthCheckResponse> getWatchBidiMethod() {
    io.grpc.MethodDescriptor<my.test.svc.HealthCheckRequest, my.test.svc.HealthCheckResponse> getWatchBidiMethod;
  ...
  public static abstract class HealthCheckImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void check(my.test.svc.HealthCheckRequest request,
     ...
     * </pre>
     */
    public void watchServer(my.test.svc.HealthCheckRequest request,
        io.grpc.stub.StreamObserver<my.test.svc.HealthCheckResponse> responseObserver) {
     ...
     * </pre>
     */
    public io.grpc.stub.StreamObserver<my.test.svc.HealthCheckRequest> watchClient(
        io.grpc.stub.StreamObserver<my.test.svc.HealthCheckResponse> responseObserver) {
     ...
     * </pre>
     */
    public io.grpc.stub.StreamObserver<my.test.svc.HealthCheckRequest> watchBidi(
        io.grpc.stub.StreamObserver<my.test.svc.HealthCheckResponse> responseObserver) {
  ...
  public static final class HealthCheckBlockingStub extends io.grpc.stub.AbstractBlockingStub<HealthCheckBlockingStub> {
     ...
     * </pre>
     */
    public my.test.svc.HealthCheckResponse check(my.test.svc.HealthCheckRequest request) {
     ...
     * </pre>
     */
    public java.util.Iterator<my.test.svc.HealthCheckResponse> watchServer(
        my.test.svc.HealthCheckRequest request) {
  ...
  public static final class HealthCheckFutureStub extends io.grpc.stub.AbstractFutureStub<HealthCheckFutureStub> {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<my.test.svc.HealthCheckResponse> check(
        my.test.svc.HealthCheckRequest request) {
  ...
  private static final class MethodHandlers<Req, Resp> implements
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_CHECK:
          serviceImpl.check((my.test.svc.HealthCheckRequest) request,
              (io.grpc.stub.StreamObserver<my.test.svc.HealthCheckResponse>) responseObserver);
          break;
        case METHODID_WATCH_SERVER:
          serviceImpl.watchServer((my.test.svc.HealthCheckRequest) request,
              (io.grpc.stub.StreamObserver<my.test.svc.HealthCheckResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class HealthCheckBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return my.test.svc.HealthProto.getDescriptor();
    }
